...
setwd(graphs_directory)
tiff(filename="Figure_S3_Final.tif", res=400,width=2400,height=2400)
...
setwd(graphs_directory)
tiff(filename="Figure_S4_Final.tif", res=400,width=3200,height=2400)
...
library(corrplot)
setwd(graphs_directory)
tiff(filename="Figure_S16_Final.tif", res=300,width=2000,height=2000)
...
tiff(paste("variable_mean_",names(mean_variables_per_ecoregion)[i],"_10_or_more_surveys_per_ecoregion.tif", sep=""),res=300,width=2600,height=1000)
...
yvalslate<-presentslate$counts/(presentslate$counts+absentslate$counts)
setwd(graphs_directory)
tiff("Figure_S23_Final.tif",res=300, width=1600, height=1600)
plot(x=xvals, y=yvalsearly, col="blue", xlab="°C", ylab="Proportion surveys with bleaching", ylim=c(0,.6))
legend("topleft", legend=c("2010 bleaching event", "2014-2017 bleaching event"), col=c("blue", "red"),pch=1, bty="o")
points(x=xvals, y=yvalslate, col="red")
dev.off()
