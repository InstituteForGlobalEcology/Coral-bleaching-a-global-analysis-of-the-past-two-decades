...
#for some unknown reason, 2017 has quotation marks around each month's raster file. This is not a typo in my code.
```

```{r calculate rate, plot on map, and write rasters}
#Calculate rate of change using years 1984 and 2017. We did not want to select ENSO years when doing the calculation. Treat the timeframe as if it were mid 1984 to mid 2017 instead of beginning of 1984 and end of 2017, because we are using the average value for each year
rate<-(r2017-r1984)/33  
rate<-rotate(rate)
